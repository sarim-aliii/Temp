...
import { 
  Lock, RefreshCw, ClipboardList, Users, Clock, Mail, 
  CheckCircle, ArrowRight, Shield, Crown, Search, Copy, 
  MoreHorizontal, Calendar, TrendingUp, AlertCircle
} from 'lucide-react';
...
const AdminDashboard = () => {
  ...
  const fetchData = async (adminKey: string) => {
    ...
    try {
      ...
      const [waitlistRes, usersRes, statsRes] = await Promise.all([
        ...
        {stats && (
            <div className="space-y-6 animate-in fade-in duration-500">
                ...
                <div className="flex flex-col md:flex-row justify-between gap-4 bg-zinc-900/30 p-2 rounded-xl border border-zinc-800/50 backdrop-blur-sm">
                    {/* Tabs */}
                    <div className="flex bg-black/50 p-1 rounded-lg border border-zinc-800 w-full md:w-auto">
                        <button 
